...
Backend-leaning full-stack engineer focused on building practical systems with Java, Python, and modern web tooling.
...
const jing = {
  ...
  coreStack: ["Java", "Python", "C++", "JavaScript", "SQL", "Spring Boot", "React", "Vue", "Redis", "Docker", "AWS"],
  alsoFamiliarWith: ["C", "C#", "Ruby", "HTML", "CSS", "MyBatis", "Spring Security", "NumPy", "Pandas", "MongoDB", "Nacos", "Apache Tomcat", "Wireshark", "Postman", "LaTeX"]
}
```

## Featured Projects

- [chrome_manager](https://github.com/jingpeng7527/chrome_manager) — A lightweight Chrome tab management agent built with JavaScript.
- [RabbitMQ](https://github.com/jingpeng7527/RabbitMQ) — Spring Boot + RabbitMQ project with Dockerized deployment and CI/CD workflows.
- [RAG-news-generation](https://github.com/jingpeng7527/RAG-news-generation) — Retrieval-augmented generation experiments for structured news content workflows.
- [jingpeng7527.github.io](https://github.com/jingpeng7527/jingpeng7527.github.io) — Personal site and portfolio source.
